      ...
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-sm text-gray-600">
            {{ linkedInProfile ? 'Connected' : 'Connect your LinkedIn account to post content directly' }}
          </p>
        </div>
      </div>
        ...
        <div class="flex items-start justify-between">
          <div>
            <p class="text-sm font-medium text-gray-900">
              {{ linkedInProfile.profile_data?.name || linkedInProfile.profile_data?.given_name || 'LinkedIn User' }}
            </p>
      ...
      <div v-if="isTokenExpired" class="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
        <div class="flex items-start gap-2">
          ...
          <div class="text-sm">
            ...
            <p class="text-yellow-700 mt-1">Your LinkedIn connection has expired. Please reconnect to continue posting.</p>
          </div>
        </div>
      </div>
